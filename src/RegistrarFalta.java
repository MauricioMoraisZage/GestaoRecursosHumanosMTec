...
public class RegistrarFalta extends javax.swing.JFrame {

    public RegistrarFalta() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("RH - Registrar Faltas");
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("          Registrar falta");

        Voltar1.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        Voltar1.setForeground(new java.awt.Color(51, 51, 255));
        ...
        TSalario.setForeground(new java.awt.Color(51, 51, 255));

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 51, 255));
        jLabel4.setText("Data [Ano-M-D]:");

        TId.setForeground(new java.awt.Color(51, 51, 255));
    ...
    private void salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarActionPerformed
        ...
        try {
            ...
            String dataStr = TSalario.getText();
            try {
                LocalDate data = LocalDate.parse(dataStr);
                boolean registrado = DatabaseManager.registrarFalta(id, data);
                if (registrado) {
                    JOptionPane.showMessageDialog(null,"Faltas registradas com sucesso.");
                    TId.setText("");
                    TSalario.setText("");
                } else {
                   JOptionPane.showMessageDialog(null,"Erro ao registrar faltas.");
                }
            } catch (HeadlessException e) {
                JOptionPane.showMessageDialog(null,"Erro! Verifique o formato da data");
            }

        } catch (HeadlessException | NumberFormatException e) {
            JOptionPane.showMessageDialog(null,"Erro... Formato da data deve ser: Ano-Mes-Dia");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarFalta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
